...
final class _RpcModuleLibraryGenerator {
  const _RpcModuleLibraryGenerator();

  static const _modulePipeline = _ModuleGenerationPipeline();
  ...
  Future<String?> generate(LibraryReader library, BuildStep buildStep) async {
    ...
    for (final module in modules) {
      ...
      final moduleOutput = await _modulePipeline.generate(
        module,
  ...
  String _emitLibrary({
    ...
    required List<_GeneratedModuleOutput> moduleOutputs,
  }) {
